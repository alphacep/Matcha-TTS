...
class FlowMatchingDurationPrediction(nn.Module):
    ...
    @torch.inference_mode()
#    def forward(self, enc_outputs, mask, n_timesteps=500, temperature=1.0):
    def forward(self, enc_outputs, mask, n_timesteps=20, temperature=1.0):
        """Forward diffusion
...
class StochasticDurationPredictor(nn.Module):
    def __init__(self, in_channels, filter_channels, kernel_size, p_dropout=0.2, n_flows=4, gin_channels=0):
        super().__init__()
